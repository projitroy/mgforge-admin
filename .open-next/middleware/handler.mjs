...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let re = ["/login", "/register"], rt = ["/dashboard", "/home\u20B9"];
      e.s(["config", 0, { matcher: ["/dashboard/:path*", "/home/:path*", "/login", "/register"] }, "middleware", 0, function(e10) {
        let { pathname: t10, search: r2 } = e10.nextUrl, n2 = !!e10.cookies.get("session")?.value, i2 = rt.some((e11) => t10.startsWith(e11));
        if (!n2 && i2) {
          let n3 = new URL("/login", e10.url);
          return n3.searchParams.set("redirect", t10 + r2), es.redirect(n3);
        }
        let a2 = re.some((e11) => t10.startsWith(e11));
        return n2 && a2 ? es.redirect(new URL("/dashboard", e10.url)) : es.next();
      }], 99446);
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/dashboard(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/home(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/login(\\\\.json)?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/register(\\\\.json)?[\\/#\\?]?$"] }];
